...
function _renderMSTopic(el, lang) {
  ...
  const svgBlock = (topic.svg && CANDLE_SVG[topic.svg])
    ? `<div style="background:#0d1f35;border-radius:12px;border:1px solid rgba(167,139,250,0.2);margin-bottom:10px;padding:14px;display:flex;align-items:center;justify-content:center;">
        ${CANDLE_SVG[topic.svg]}
       </div>`
    : '';
